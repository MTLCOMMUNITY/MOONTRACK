...
export function AdminSettings() {
  ...
  async function handleSave() {
    ...
    const updates = [
      supabase
        .from('app_settings')
        .upsert({ key: 'course_fee', value: courseFee }),
      supabase
        .from('app_settings')
        .upsert({ key: 'course_name', value: courseName }),
    ]
        ...
        <div className='grid gap-6 lg:grid-cols-2'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                These values are used on the public payment page shown to
                students.
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Public frontend vars belong in Vercel. Edge Function secrets
                belong in Supabase project secrets.
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-3'>
              ...
              <p className='pt-1 text-xs text-muted-foreground'>
                Set `VITE_*` vars in Vercel and server-only `FLW_*` vars in
