      ...
      <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>Clicks that became students</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            {loading ? <Skeleton className='h-8 w-28' /> : (
              <div className='text-2xl font-bold'>{fmt(data.avgCommission)}</div>
            )}
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>Referral links in use</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-7'>
        ...
        <Card className='col-span-1 lg:col-span-4'>
          <CardHeader>
            ...
            <CardDescription>Referral codes ranked by total conversions</CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
